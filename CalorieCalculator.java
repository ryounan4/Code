/* This program takes in the user's input of their age, gender, weight, height, activity level, and preferred diet type, and returns the number of calories, protein, fat, and carbs that they should consume daily in order to maintain their current weight and build muscle. */
...
class CalorieCalculator {
  ...
  public static int numCals() {
    ...
    if (gender.equals("male")) {
      // Uses the Harris-Benedict equation to estimate the number of calories your body burns at rest
      calories = (int) ((6.23762 * weight) + (12.7084 * height) - (6.755 * age) + 66.473);
